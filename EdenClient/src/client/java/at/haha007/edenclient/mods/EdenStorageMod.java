...
public class EdenStorageMod {
    ...
    private static synchronized void registerPayloadTypes() {
        ...
        PayloadTypeRegistry.clientboundPlay().register(EdenStoragePayload.TYPE, EdenStoragePayload.CODEC);
        PayloadTypeRegistry.serverboundPlay().register(EdenStoragePayload.TYPE, EdenStoragePayload.CODEC);
